...
## Version
- **24/09/2026:** Update buildkite agent (v4.0.6), kubectl (v1.37.1) and pnpm (v12.6.0)
- **21/09/2026:** Update buildkite agent (v4.0.4), goreleaser (v2.18.2), grype (v0.119.0), pnpm (v12.5.1), reviewdog (v0.21.2) and syft (v1.52.0)
...
- **01/09/2026:** Update buildkite agent (v3.137.2), golangci-lint (v2.13.2), grype (v0.118.0), kubectl (v1.37.0), pnpm (v11.24.0), syft (v1.51.1) and typos (v1.50.0)
...
- **11/05/2026:** Update gh (v2.92.0), pnpm (v11.0.9), s6-overlay (v3.2.3.0) and typos (v1.46.1)
- **08/05/2026:** Update buildkite agent (v3.126.0) and pnpm (v11.0.8)
- **07/05/2026:** Update golangci-lint (v2.12.2) and pnpm (v10.33.4)
- **04/05/2026:** Update buildkite agent (v3.125.0) and golangci-lint install path
- **04/05/2026:** Update golangci-lint (v2.12.1), grype (v0.112.0), syft (v1.44.0) and typos (v1.46.0)
- **28/04/2026:** Update buildkite agent (v3.124.0), goreleaser (v2.15.4), grype (v0.111.1), kubectl (v1.36.0), pnpm (v10.33.2), syft (v1.43.0) and typos (v1.45.2)
- **15/04/2026:** Update goreleaser (v2.15.3) and add shellcheck (v0.11.0)
- **14/04/2026:** Update buildkite agent (v3.123.0) and typos (v1.45.1)
- **10/04/2026:** Update grype (v0.111.0)
- **09/04/2026:** Update buildkite agent (v3.122.0), helm (v4.1.4) and syft (v1.42.4)
- **02/04/2026:** Update typos (v1.45.0)
- **01/04/2026:** Update buildkite agent (v3.121.0), buildx (v0.33.0), goreleaser (v2.15.2) and add typos
- **25/03/2026:** Update buildkite agent (v3.120.3) and pnpm (v10.33.0)
- **23/03/2026:** Update golangci-lint (v2.11.4), grype (v0.110.0), kubectl (v1.35.3) and syft (v1.42.3)
- **19/03/2026:** Update buildkite agent (v3.120.1)
- **17/03/2026:** Update buildkite agent (v3.120.0), helm (v4.1.3) and pnpm (v10.32.1)
- **11/03/2026:** Update buildkite agent (v3.119.2), golangci-lint (v2.11.3), goreleaser (v2.14.3), grype (v0.109.1), pnpm (v10.32.0) and syft (v1.42.2)
- **08/03/2026:** Update golangci-lint (v2.11.2), goreleaser (v2.14.2) and pnpm (v10.31.0)
- **06/03/2026:** Update buildkite agent (v3.119.1) and buildx (v0.32.1)
- **03/03/2026:** Update buildkite agent (v3.118.1), goreleaser (v2.14.1), kubectl (v1.35.2) and pnpm (v10.30.3)
- **21/02/2026:** Update buildkite agent (v3.118.0), golangci-lint (v2.10.1), grype (v0.109.0), pnpm (v10.30.1) and syft (v1.42.1)
- **15/02/2026:** Fix frozen version resolution in the updater
- **14/02/2026:** Update buildkite agent (v3.117.0), golangci-lint (v2.9.0), grype (v0.108.0), helm (v4.1.1), kubectl (v1.35.1), pnpm (v10.29.3) and syft (v1.42.0)
- **31/01/2026:** Update buildkite agent (v3.116.0), buildx (v0.31.1), golangci-lint (v2.8.0), goreleaser (v2.13.3), grype (v0.107.0), helm (v4.1.0), kubectl (v1.35.0), s6-overlay (v3.2.2.0), pnpm (v10.28.2) and syft (v1.41.1)
- **08/12/2025:** Update buildkite agent (v3.115.2), goreleaser (v2.13.1), grype (v0.104.2), helm (v4.0.4), pnpm (v10.26.1) and syft (v1.38.2)
- **08/12/2025:** Update buildkite agent (v3.114.1), buildx (v0.30.1), golangci-lint (v2.7.2), goreleaser (v2.13.0), grype (v0.104.1), helm (v4.0.1), pnpm (v10.24.0) and syft (v1.38.0)
- **17/11/2025:** Update buildkite agent (v3.112.0), buildx (v0.30.0), golangci-lint (v2.6.2), grype (v0.103.0), helm (v4.0.0), pnpm (v10.22.0) and syft (v1.37.0)
- **29/10/2025:** Update buildkite agent (v3.110.0), chart-testing (v3.14.0), goreleaser (v2.12.7) and pnpm (v10.20.0)
...
- **23/01/2025:** Update buildkite agent (v3.90.0), pnpm (v9.15.4), buildx (v0.20.1), golangci-lint (v1.63.4), reviewdog (v0.20.3), chart-testing (v3.12.0), helm (v3.17.0), kubectl (v1.32.1)
...
- **16/09/2024:** Downgrade kubectl (v1.31.0)
- **15/09/2024:** Update buildkite agent (v3.81.0), pnpm (v9.10.0), buildx (v0.17.1), golangci-lint (v1.61.0), helm (v3.16.1), kubectl (v1.31.1)
- **08/09/2024:** Update buildkite agent (v3.80.0), pnpm (v9.9.0), golangci-lint (v1.60.3), helm (v3.15.4), chart-testing (v3.11.0)
- **14/08/2024:** Update buildkite agent (v3.77.0), pnpm (v9.7.0), golangci-lint (v1.60.1), reviewdog (v0.20.1), buildx (v0.16.2), helm (v3.15.3), kubectl (v1.30.1)
- **10/06/2024:** Update buildkite agent (v3.73.1), pnpm (v9.2.0), golangci-lint (v1.59.1), reviewdog (v0.17.5), buildx (v0.14.1), helm (v3.15.1), kubectl (v1.30.1)
- **19/04/2024:** Update buildkite agent (v3.70.0), pnpm (v9.0.4), buildx (v0.14.0), kubectl (v1.31.0)
- **19/04/2024:** Use custom cr version
- **17/04/2024:** Fix ESLint version
- **17/04/2024:** Update pnpm (v9.0.1), golangci-lint (v1.57.2), reviewdog (v0.17.3), helm (v3.14.4), kubectl (v1.29.4)
- **13/04/2024:** Update buildkite agent (v3.69.0), pnpm (v8.15.6)
- **19/03/2024:** Update buildx (v0.13.1), reviewdog (v0.17.2)
- **13/03/2024:** Update buildkite agent (v3.66.0)
- **06/03/2024:** Update buildkite agent (v3.65.0), pnpm (v8.15.4), buildx (v0.13.0), helm (v3.14.2), kubectl (v1.29.2)
- **18/02/2024:** Update buildkite agent (v3.63.0), pnpm (v8.15.3), golangci-lint (v1.56.2), reviewdog (v0.17.1), helm (v3.14.1), kubectl (v1.29.1)
